...
LAG_이동영역 = 8 #LAG 자석두께 제외, 단방향 토탈 16mm

LAG_magnet_width = 10
LAG_magnet_length = 30
LAG_magnet_height = 5

LAG_magnet_margin = 0.1

LAG_magnethole_width = LAG_magnet_width+LAG_magnet_margin*2
LAG_magnethole_length = 10
LAG_magnethole_height = LAG_magnet_height+LAG_magnet_margin*2
